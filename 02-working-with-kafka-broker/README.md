...
reate, delete, describe, or change a topic.
Option                                   Description                            
------                                   -----------                            
...
```
kafka-topics --create --if-not-exists --bootstrap-server kafka-1:19092 --topic test-topic --partitions 6 --replication-factor 2
```
