...
- [Bridge MQTT to Kafka with Kafka Connect or Apache NiFi or MiNiFi](#bridge-mqtt-to-kafka-with-kafka-connect-or-apache-nifi-or-minifi)
  - [Using Kafka Connect](#using-kafka-connect)
  - [Using Apache NiFi (optional)](#using-apache-nifi-optional)
    - [Add a Process Group first](#add-a-process-group-first)
    - [Adding a `ConsumeMQTT` processor](#adding-a-consumemqtt-processor)
    - [Adding a `ProduceKafka` processor](#adding-a-producekafka-processor)
    - [Connecting the processors](#connecting-the-processors)
    - [Configure the Publish Kafka processor](#configure-the-publish-kafka-processor)
  - [Using Apache MiNiFi C++ (optional)](#using-apache-minifi-c-optional)
- [Create Avro Schema for downstream processing](#create-avro-schema-for-downstream-processing)
  - [Transforming JSON to JSON using JOLT](#transforming-json-to-json-using-jolt)
...
- [Using Apache NiFi to transform from raw to avro message](#using-apache-nifi-to-transform-from-raw-to-avro-message)
  - [Add a Process Group first](#add-a-process-group-first-1)
  - [Adding a `ConsumeKafka` processor](#adding-a-consumekafka-processor)
  - [Flatten raw message using JOLT transformation](#flatten-raw-message-using-jolt-transformation)
  - [Adding a `ProduceKafka` processor](#adding-a-producekafka-processor-1)
  - [Connecting the processors](#connecting-the-processors-1)
  - [Start the first two processors](#start-the-first-two-processors)
  - [Configure the Publish Kafka processor](#configure-the-publish-kafka-processor-1)
...
- [Write the Avro formatted messages as Iceberg tables in S3](#write-the-avro-formatted-messages-as-iceberg-tables-in-s3)
  - [Create the Iceberg catalog namespace](#create-the-iceberg-catalog-namespace)
  - [Create the Iceberg table](#create-the-iceberg-table)
  - [Create the connector control topic](#create-the-connector-control-topic)
  - [Deploy the Iceberg Sink Connector](#deploy-the-iceberg-sink-connector)
  - [Verify data arrival in S3 (RustFS)](#verify-data-arrival-in-s3-rustfs)
- [Query the Iceberg table with Trino](#query-the-iceberg-table-with-trino)
  - [Query using the Trino CLI](#query-using-the-trino-cli)
  - [Query using DBeaver](#query-using-dbeaver)
- [Write the Avro formatted messages to TimescaleDB](#write-the-avro-formatted-messages-to-timescaledb)
  ...
  - [Create the target table and hypertable](#create-the-target-table-and-hypertable)
  - [Configure the Kafka Connect JDBC Sink connector](#configure-the-kafka-connect-jdbc-sink-connector)
  - [Verify data is flowing into TimescaleDB](#verify-data-is-flowing-into-timescaledb)
- [Visualize the TimescaleDB data in Grafana](#visualize-the-timescaledb-data-in-grafana)
  - [Open Grafana](#open-grafana)
  - [Check TimescaleDB data source](#check-timescaledb-data-source)
  - [Import the Energy Monitoring dashboard](#import-the-energy-monitoring-dashboard)
